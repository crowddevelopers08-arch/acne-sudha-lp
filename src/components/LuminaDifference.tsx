...
const cases = [
  {
    ...
    gender: 'male · 25',
    location: 'Kakinada',
    concern: 'Acne scars & uneven texture',
    area: 'Cheeks',
    treatment: 'Oral treatment with peels',
    sessions: '5 Sessions',
    duration: '3 Months',
    result: '82%',
    resultLabel: 'Marks Reduced',
    quote: 'I was worried about my acne scars and rough skin texture. The treatment helped smoothen my skin and made my scars look lighter.',
  },

  {
    ...
    gender: 'male · 28',
    location: 'Kakinada',
    concern: 'Pimples with acne marks',
    area: 'Face',
    ...
    quote: 'My pimples kept coming back and left dark marks. After the peel sessions, my breakouts reduced and my marks started fading slowly.',
  },
  {
    before: '/ACNE.png',
    after: '/ACNE1.png',
    ...
    gender: 'Female · 27',
    location: 'Kakinada',
    concern: 'Active acne & redness',
    area: 'Full Face',
    treatment: 'Oral treatment with Acne control peels and lasers',
    sessions: '8 Sessions',
    duration: '4 Months',
    result: '85%',
    resultLabel: 'Scar Reduction',
    quote: 'I had painful pimples and redness for years. After starting treatment, my acne reduced well and my skin feels much calmer now.',
  },
];
